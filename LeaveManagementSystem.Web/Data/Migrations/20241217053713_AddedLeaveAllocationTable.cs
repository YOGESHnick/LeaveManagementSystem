    ...
    public partial class AddedLeaveAllocationTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveAllocations_LeavesTypes_LeaveTypeId",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: "408aa945-3d84-4421-8342-7269ec64d949",
                columns: new[] { "ConcurrencyStamp", "PasswordHash", "SecurityStamp" },
                values: new object[] { "1426d688-0712-4c22-8678-f03315e2b643", "AQAAAAIAAYagAAAAELLE8wj55yxS0We4OeMCSMabnnKZWO8eE/CKhYGy4ZdB4eVGwJH5/ThbtHaWYDBteg==", "f3e65bf6-50f5-46c0-8020-3cda7970586b" });
        }
    }
}
